...
class Controller {
  ...
  initTouchButtons() {
    ...
    this.touchButtons.push(new TouchButton(GameAssets.controls.tailAttack[0],canvasW - btnSize * 5 - margin,canvasH - btnSize * 2 - verticalOffset,180,btnSize,() => this.pressTailAttackMobile()));
   ...
   * Converts touch coordinates to canvas coordinates and triggers
   * button presses for any touch buttons that were pressed.
   *
   * @param {TouchEvent} e - The touchstart event object containing touch points.
   */
  handleTouchStart(e) {
    e.preventDefault();
   ...
   * Releases all touch buttons and resets character mobile movement and attacks.
   *
   * @param {TouchEvent} e - The touchend event object containing touch points.
   */
  handleTouchEnd(e) {
    e.preventDefault();
