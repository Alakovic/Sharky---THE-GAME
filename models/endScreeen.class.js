class EndScreen extends DrawableObject {
  ...
  drawWinScreen() {
    this.background.src =
      "assets/images/game_interface/endScreenButtons/Mesa de trabajo 1.png";
  ...
  drawLoseScreen() {
    this.background.src =
      "assets/images/game_interface/endScreenButtons/black.png";
  ...
  drawGameOverTitle() {
    ...
    this.gameOverTitle.src =
      "assets/images/game_interface/endScreenButtons/Recurso 10.png";
    this.titleX = 300;
    this.titleY = 200;
    this.titleWidth = 600;
    this.titleHeight = 80;
  ...
  handleMouseMove(event) {
    ...
    this.tryAgainButton.isHovered = this.tryAgainButton.isClicked(
      mouseX,
      mouseY
    );
  ...
  stopWorld() {
    ...
    if (this.world.sound && this.world.sound.background) {
      this.world.sound.background.pause();
    }
    if (this.world.controller) {
      this.world.controller.removeTouchEvents();
    }
